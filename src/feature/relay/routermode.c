 ...
 */
MOCK_IMPL(int, server_mode, (const or_options_t *options))
{
 ...
 */
MOCK_IMPL(int, public_server_mode, (const or_options_t *options))
{
 ...
 */
MOCK_IMPL(int, advertised_server_mode, (void))
{
