...
consensus_cache_add(consensus_cache_t *cache,
                    const struct config_line_t *labels, const uint8_t *data,
                    size_t datalen);
...
void consensus_cache_find_all(smartlist_t *out, consensus_cache_t *cache,
                              const char *key, const char *value);
void consensus_cache_filter_list(smartlist_t *lst, const char *key,
                                 const char *value);
