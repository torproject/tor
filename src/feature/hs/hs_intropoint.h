...
STATIC int verify_establish_intro_cell(const trn_cell_establish_intro_t *out,
...
STATIC int handle_introduce1(or_circuit_t *client_circ, const uint8_t *request,
                             size_t request_len);
