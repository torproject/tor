...
struct routerstatus_t {
  ...
  unsigned int
      is_stable : 1; /**< True iff this router stays up a long time. */
  ...
  unsigned int
      is_named : 1; /**< True iff "nickname" belongs to this router. */
  ...
  unsigned int is_hs_dir : 1; /**< True iff this router is a v2-or-later hidden
                               * service directory. */
  unsigned int
      is_v2_dir : 1; /** True iff this router publishes an open DirPort
  ...
  unsigned int
      has_exitsummary : 1; /**< The vote/consensus had exit summaries */
