...
MOCK_DECL(char *, networkstatus_get_cache_fname,
...
routerstatus_t *networkstatus_vote_find_mutable_entry(networkstatus_t *ns,
                                                      const char *digest);
int networkstatus_vote_find_entry_idx(networkstatus_t *ns, const char *digest,
                                      int *found_out);

MOCK_DECL(download_status_t *, networkstatus_get_dl_status_by_flavor,
          (consensus_flavor_t flavor));
MOCK_DECL(download_status_t *, networkstatus_get_dl_status_by_flavor_bootstrap,
          (consensus_flavor_t flavor));
MOCK_DECL(download_status_t *, networkstatus_get_dl_status_by_flavor_running,
          (consensus_flavor_t flavor));
...
int networkstatus_set_current_consensus(const char *consensus,
                                        ...
                                        const char *flavor, unsigned flags,
...
void set_routerstatus_from_routerinfo(routerstatus_t *rs, const node_t *node,
