...
vote_routerstatus_t *dir_common_gen_routerstatus_for_v3ns(int idx, time_t now);

int dir_common_construct_vote_1(
    networkstatus_t **vote, authority_cert_t *cert1, crypto_pk_t *sign_skey,
    vote_routerstatus_t *(*vrs_gen)(int idx, time_t now),
    networkstatus_t **vote_out, int *n_vrs, time_t now, int clear_rl);

int dir_common_construct_vote_2(
    networkstatus_t **vote, authority_cert_t *cert2, crypto_pk_t *sign_skey,
    vote_routerstatus_t *(*vrs_gen)(int idx, time_t now),
    networkstatus_t **vote_out, int *n_vrs, time_t now, int clear_rl);

int dir_common_construct_vote_3(
    networkstatus_t **vote, authority_cert_t *cert3, crypto_pk_t *sign_skey,
    vote_routerstatus_t *(*vrs_gen)(int idx, time_t now),
    networkstatus_t **vote_out, int *n_vrs, time_t now, int clear_rl);
