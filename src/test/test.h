...
extern struct testcase_t crypto_dnssec_tests[];
extern struct testcase_t crypto_dnssec_openssl_tests[];
...
extern struct testcase_t dns_message_tests[];
extern struct testcase_t dns_resolver_tests[];
extern struct testcase_t dns_string_tests[];
extern struct testcase_t dns_wireformat_tests[];
