...
static uint8_t v0_test_plaintext[] =
    ...
    {0x4e, 0x69, 0x63, 0x6b, 0x6e, 0x61, 0x6d, 0x65, 0x00, 0x00, 0x00, 0x00,
     ...
     0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x00, 0x01, 0x02, 0x03,
     0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
     0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04,
     0x03, 0x02, 0x01, 0x00, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
     0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x0f, 0x0e, 0x0d, 0x0c,
...
static uint8_t v1_test_plaintext[] =
    ...
    {0x01,
     ...
     0x24, 0x30, 0x30, 0x30, 0x31, 0x30, 0x32, 0x30, 0x33, 0x30, 0x34, 0x30,
     0x35, 0x30, 0x36, 0x30, 0x37, 0x30, 0x38, 0x30, 0x39, 0x30, 0x41, 0x30,
     0x42, 0x30, 0x43, 0x30, 0x44, 0x30, 0x45, 0x30, 0x46, 0x31, 0x30, 0x31,
...
static uint8_t v2_test_plaintext[] =
    ...
    {0x02,
     ...
     ,
     /* 20 bytes dummy rendezvous cookie */
     0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
     0x0c, 0x0d, 0x0e, 0x0f, 0x10, 0x11, 0x12, 0x13,
     /* 128 bytes dummy DH handshake data */
...
static ssize_t make_intro_from_plaintext(void *buf, size_t len,
                                         crypto_pk_t *key, void **cell_out);
...
do_parse_test(uint8_t *plaintext, size_t plaintext_len, int phase)
{
  ...
  r = make_intro_from_plaintext(plaintext, plaintext_len, k, (void **)(&cell));
  tt_assert(r > 0);
  tt_assert(cell);
  cell_len = r;
...
static ssize_t
make_intro_from_plaintext(void *buf, size_t len, crypto_pk_t *key,
                          void **cell_out)
{
  char *cell = NULL;
  ...
  /* Do encryption */
  r = crypto_pk_obsolete_public_hybrid_encrypt(key, cell + DIGEST_LEN,
                                               ciphertext_size, buf, len,
...
{
  (void)arg;
  do_decrypt_test(v3_no_auth_test_plaintext,
                  sizeof(v3_no_auth_test_plaintext));
  do_decrypt_test(v3_basic_auth_test_plaintext,
                  sizeof(v3_basic_auth_test_plaintext));
}
...
{
  (void)arg;
  do_early_parse_test(v3_no_auth_test_plaintext,
                      sizeof(v3_no_auth_test_plaintext));
  do_early_parse_test(v3_basic_auth_test_plaintext,
                      sizeof(v3_basic_auth_test_plaintext));
}
...
{
  (void)arg;
  do_late_parse_test(v3_no_auth_test_plaintext,
                     sizeof(v3_no_auth_test_plaintext));
  do_late_parse_test(v3_basic_auth_test_plaintext,
                     sizeof(v3_basic_auth_test_plaintext));
}
...
struct testcase_t introduce_tests[] = {INTRODUCE_LEGACY(early_parse_v0),
