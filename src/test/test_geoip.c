...
#define CHECK_COUNTRY(country, val)                                     \
  do {                                                                  \
...
test_geoip(void *arg)
{
  ...
  char *s = NULL, *v = NULL;
  const char
      *bridge_stats_1 = "bridge-stats-end 2010-08-12 13:27:30 (86400 s)\n"
...
static const char GEOIP_CONTENT[] = "134445936,134445939,MP\n"
