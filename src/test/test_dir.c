...
static int NS(public_server_mode)(const or_options_t *options)
{
  (void)options;
...
void NS(directory_initiate_request)(directory_request_t *req)
{
  (void)req;
...
struct testcase_t dir_tests[] = {
    ...
    DIR(format_versions_list, TT_FORK), END_OF_TESTCASES};
