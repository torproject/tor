...
test_address_ifaddrs_to_smartlist(void *arg)
{
  ...
  addr_len = tor_addr_to_sockaddr(tor_addr, 0, sockaddr_to_check,
...
test_address_ip_adapter_addresses_to_smartlist(void *arg)
{
  ...
  addrs1 = tor_malloc_zero(sizeof(IP_ADAPTER_ADDRESSES));

  addrs1->FirstUnicastAddress = unicast11 =
  ...
  addrs1->Next = addrs2 = tor_malloc_zero(sizeof(IP_ADAPTER_ADDRESSES));

  addrs2->FirstUnicastAddress = unicast21 =
      tor_malloc_zero(sizeof(IP_ADAPTER_UNICAST_ADDRESS));
...
test_address_udp_socket_trick_whitebox(void *arg)
{
  ...
  hack_retval = get_interface_address6_via_udp_socket_hack(LOG_DEBUG, AF_INET,
                                                           addr_from_hack);
  ...
  hack_retval = get_interface_address6_via_udp_socket_hack(LOG_DEBUG, AF_INET6,
                                                           addr_from_hack);
...
test_address_udp_socket_trick_blackbox(void *arg)
{
  ...
  retval = get_interface_address6_via_udp_socket_hack(
      LOG_DEBUG, AF_INET + AF_INET6, &addr4);
...
test_address_get_if_addrs_internal_fail(void *arg)
{
  ...
  MOCK(get_interface_addresses_raw, mock_get_interface_addresses_raw_fail);
...
test_address_tor_addr_to_in6(void *ignored)
{
  ...
  uint8_t expected[16] = {42, 1, 2,  3,  4,  5,  6,  7,
