...
test_dir_handle_get_rendezvous2_on_encrypted_conn_success(void *data)
{
  ...
  MOCK(connection_write_to_buf_impl_, connection_write_to_buf_mock);
  MOCK(router_get_my_routerinfo, dhg_tests_router_get_my_routerinfo);
...
test_dir_handle_get_status_vote_current_consensus_ns(void *data)
{
  ...
  MOCK(geoip_get_country_by_addr, dhg_tests_geoip_get_country_by_addr);
  MOCK(get_options, mock_get_options);
...
test_dir_handle_get_status_vote_next_consensus(void *data)
{
  ...
  MOCK(dirvote_get_pending_consensus, dhg_tests_dirvote_get_pending_consensus);
