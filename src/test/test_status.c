...
test_status_count_circuits(void *arg)
{
  ...
  MOCK(circuit_get_global_list, status_count_circuits_circuit_get_global_list);
...
test_status_hb_fails(void *arg)
{
  ...
  MOCK(public_server_mode, status_hb_fails_public_server_mode);
  MOCK(router_get_my_routerinfo, status_hb_fails_router_get_my_routerinfo);
...
static void status_hb_not_in_consensus_logv(int severity,
...
test_status_hb_not_in_consensus(void *arg)
{
  ...
  MOCK(we_are_hibernating, status_hb_not_in_consensus_we_are_hibernating);
  MOCK(public_server_mode, status_hb_not_in_consensus_public_server_mode);
  MOCK(router_get_my_routerinfo, status_hb_not_in_consensus_get_my_routerinfo);
  MOCK(node_get_by_id, status_hb_not_in_consensus_node_get_by_id);
  MOCK(logv, status_hb_not_in_consensus_logv);
  MOCK(server_mode, status_hb_not_in_consensus_server_mode);
                                ...
                                const char *format, va_list ap)
{
  ...
  case 3:
    tt_int_op(severity, OP_EQ, LOG_NOTICE);
    tt_u64_op(domain, OP_EQ, LD_HEARTBEAT);
    tt_ptr_op(strstr(funcname, "rep_hist_log_circuit_handshake_stats"), OP_NE,
              NULL);
    tt_ptr_op(suffix, OP_EQ, NULL);
    tt_str_op(
        format, OP_EQ,
  ...
  case 4:
    tt_int_op(severity, OP_EQ, LOG_NOTICE);
    tt_u64_op(domain, OP_EQ, LD_HEARTBEAT);
    tt_ptr_op(strstr(funcname, "rep_hist_log_link_protocol_counts"), OP_NE,
              NULL);
    break;
  case 5:
    tt_int_op(severity, OP_EQ, LOG_NOTICE);
...
test_status_hb_simple(void *arg)
{
  ...
  MOCK(we_are_hibernating, status_hb_simple_we_are_hibernating);
  MOCK(public_server_mode, status_hb_simple_public_server_mode);
  MOCK(get_uptime, status_hb_simple_get_uptime);
  MOCK(get_bytes_read, status_hb_simple_get_bytes_read);
  MOCK(get_bytes_written, status_hb_simple_get_bytes_written);
  MOCK(logv, status_hb_simple_logv);
  MOCK(server_mode, status_hb_simple_server_mode);
...
test_status_hb_calls_log_accounting(void *arg)
{
  ...
  MOCK(we_are_hibernating, status_hb_calls_log_accounting_we_are_hibernating);
  MOCK(public_server_mode, status_hb_calls_log_accounting_public_server_mode);
  MOCK(get_uptime, status_hb_calls_log_accounting_get_uptime);
  MOCK(get_bytes_read, status_hb_calls_log_accounting_get_bytes_read);
  MOCK(get_bytes_written, status_hb_calls_log_accounting_get_bytes_written);
  MOCK(logv, status_hb_calls_log_accounting_logv);
  MOCK(server_mode, status_hb_calls_log_accounting_server_mode);
  MOCK(get_or_state, status_hb_calls_log_accounting_get_or_state);
...
status_hb_calls_log_accounting_get_or_state(void)
{
  ...
  status_hb_calls_log_accounting_mock_state->AccountingBytesWrittenInInterval =
      0;
...
static void
status_hb_packaged_cell_fullness_logv(int severity, log_domain_mask_t domain,
                                      const char *funcname, const char *suffix,
                                      const char *format, va_list ap);
...
test_status_hb_packaged_cell_fullness(void *arg)
{
  ...
  MOCK(get_uptime, status_hb_packaged_cell_fullness_get_uptime);
  MOCK(get_bytes_read, status_hb_packaged_cell_fullness_get_bytes_read);
  MOCK(get_bytes_written, status_hb_packaged_cell_fullness_get_bytes_written);
  MOCK(logv, status_hb_packaged_cell_fullness_logv);
  MOCK(server_mode, status_hb_packaged_cell_fullness_server_mode);
  MOCK(accounting_is_enabled,
...
static void status_hb_tls_write_overhead_logv(int severity,
                                              log_domain_mask_t domain,
                                              const char *funcname,
                                              const char *suffix,
                                              const char *format, va_list ap);
...
test_status_hb_tls_write_overhead(void *arg)
{
  ...
  MOCK(we_are_hibernating, status_hb_tls_write_overhead_we_are_hibernating);
  MOCK(public_server_mode, status_hb_tls_write_overhead_public_server_mode);
  MOCK(get_uptime, status_hb_tls_write_overhead_get_uptime);
  MOCK(get_bytes_read, status_hb_tls_write_overhead_get_bytes_read);
  MOCK(get_bytes_written, status_hb_tls_write_overhead_get_bytes_written);
  MOCK(logv, status_hb_tls_write_overhead_logv);
  MOCK(server_mode, status_hb_tls_write_overhead_server_mode);
  MOCK(accounting_is_enabled,
...
struct testcase_t status_tests[] = {
    ...
    {"hb_not_in_consensus", test_status_hb_not_in_consensus, TT_FORK, NULL,
     NULL},
    {"hb_calls_log_accounting", test_status_hb_calls_log_accounting, TT_FORK,
     NULL, NULL},
    {"hb_packaged_cell_fullness", test_status_hb_packaged_cell_fullness,
     TT_FORK, NULL, NULL},
    {"hb_tls_write_overhead", test_status_hb_tls_write_overhead, TT_FORK, NULL,
     NULL},
    END_OF_TESTCASES};
