 ...
 *    circuits are usually very short lived and this act as a distinguisher.
 *
 * Client-side rendezvous circuit hiding machine:
 *
 *    This machine hides client-side rendezvous circuits by sending padding
 *    during circuit construction and also after the circuit has opened.
 *
 * Please see proposal XXX for more details on the machines.
 *
                                            ...
                                            bool is_client)
{
  ...
  /* Histogram is: (30 msecs, 200 msecs, infinity). */
