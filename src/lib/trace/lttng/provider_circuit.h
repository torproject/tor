...
/**
 * \file provider_circuit.h
 * \brief Header file that contains the LTTng probes for the tracepoint of the
 *        circuit subsystem.
 **/
...
#define TRACEPOINT_INCLUDE "./lib/trace/lttng/provider_circuit.h"
