...
void token_bucket_cfg_init(token_bucket_cfg_t *cfg, uint32_t rate,
                           uint32_t burst);
...
void token_bucket_rw_init(token_bucket_rw_t *bucket, uint32_t rate,
                          uint32_t burst, uint32_t now_ts);

void token_bucket_rw_adjust(token_bucket_rw_t *bucket, uint32_t rate,
                            uint32_t burst);
...
int token_bucket_rw_dec(token_bucket_rw_t *bucket, ssize_t n_read,
                        ssize_t n_written);
