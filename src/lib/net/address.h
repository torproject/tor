...
/* If for_listening is true allow v4n_addr = 0 too.
 * else allow only non-zero v4n_addr. */
#define tor_addr_is_valid_ipv4n(v4n_addr,for_listening) \
        (for_listening == 1 || v4n_addr != 0)
